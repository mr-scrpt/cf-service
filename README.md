...
> 📖 **Детальна інструкція:** Якщо ви хочете запустити цей проєкт локально, перегляньте повну інструкцію по встановленню, налаштуванню та запуску.

### [👉 LAUNCH.md - Інструкція по запуску проєкту](./LAUNCH.md)

**Що ви знайдете в інструкції:**
- 📦 Встановлення залежностей
- ⚙️ Налаштування environment variables
- 🗄️ Запуск MongoDB
- 🤖 Запуск Telegram Bot, REST API, Web Panel
